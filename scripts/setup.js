...
function warnPublicBaseUrl(baseUrl, portValue) {
  ...
  try {
    ...
    if (u.protocol === 'https:') {
      ...
      console.log('  Use your own trusted HTTPS hostname, for example your DuckDNS name or domain via Caddy/Nginx, for iOS installs.');
    }
  } catch {
    console.log('\n  Public base URL warning: enter a full URL like https://your-hostname.example:8444');
  }
}
